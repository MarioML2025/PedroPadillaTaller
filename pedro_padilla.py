...
@app.get("/train")
def train_model():
    df = pd.read_csv("C:\DMC_Cursos\ML_Especializacion\Data_Taller_MLE.csv")  # Se asume un dataset llamado data.csv en la raíz
    setup(df, target='loan_status', silent=True, session_id=123)
